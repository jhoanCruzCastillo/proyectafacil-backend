...
// Prompt del sistema (pilar 1 del tab "Contexto IA") para la FTE de Educación Inicial, Primaria y
// Secundaria (EBR) — V03. Define el COMPORTAMIENTO de la IA en el llenado asistido: rol, orden de
...
//
// El contenido es prácticamente idéntico al de PromptSistemaCuidadoDiurnoSeeder — el §7 (formato
...
//
// Idempotente. Uso: php spark db:seed PromptSistemaFTEEBRSeeder
class PromptSistemaFTEEBRSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $markdown = (string) file_get_contents(__DIR__ . '/content/fte-ebr-prompt-sistema.md');
