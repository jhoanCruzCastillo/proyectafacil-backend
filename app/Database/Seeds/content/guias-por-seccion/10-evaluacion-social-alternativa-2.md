# SECCIÓN N°10: EVALUACIÓN SOCIAL - ALTERNATIVA 2

## Descripción de la sección

- **Qué representa:** SECCIÓN N°10: EVALUACIÓN SOCIAL - ALTERNATIVA 2.
- **Objetivo (según instructivo):** Información no determinada por los archivos proporcionados.
- **Hoja Excel:** `Evaluación Social Alt2`
- **JSON `id` de sección:** `13`
...
**Esta guía documenta la Alternativa 2** (JSON id `13`).

### Subsecciones / grupos

- `13.01` — 10.01 BENEFICIOS SOCIALES
- `13.02` — 10.02 COSTOS SOCIALES
- `13.03` — 10.03 FLUJO DE COSTOS A PRECIOS SOCIALES (EVALUACIÓN SOCIAL)
- `13.04` — 10.04 INDICADORES DE RENTABILIDAD SOCIAL
- `13.05` — 10.05 ANÁLISIS DE SENSIBILIDAD
...
## Campo 13.01.1 — Benificios de la intervención
...
## Campo 13.02.1 — Transformación de costos de inversión a precios sociales
...
## Campo 13.02.2 — Transformación de costos de operación y mantenimiento a precios sociales
...
## Campo 13.03.1 — FLUJO DE COSTOS A PRECIOS SOCIALES (EVALUACIÓN SOCIAL)
...
## Campo 13.04.1 — INDICADORES DE RENTABILIDAD SOCIAL
...
## Campo 13.05.1 — ANALISIS DE SENSIBILIDAD BIDIMENSIONAL
...
|---|---|---|---|---|
| 13.01.1 | Benificios de la intervención | tabla | Sí | Llenar tabla |
| 13.02.1 | Transformación de costos de inversión a precios sociales | tabla | Sí | Llenar tabla |
| 13.02.2 | Transformación de costos de operación y mantenimiento a precios sociales | tabla | Sí | Llenar tabla |
| 13.03.1 | FLUJO DE COSTOS A PRECIOS SOCIALES (EVALUACIÓN SOCIAL) | tabla | Sí | Llenar tabla |
| 13.04.1 | INDICADORES DE RENTABILIDAD SOCIAL | tabla | Sí | Llenar tabla |
| 13.05.1 | ANALISIS DE SENSIBILIDAD BIDIMENSIONAL | tabla | Sí | Llenar tabla |
