# SECCIÓN N°10: EVALUACIÓN SOCIAL - ALTERNATIVA 3

## Descripción de la sección

- **Qué representa:** SECCIÓN N°10: EVALUACIÓN SOCIAL - ALTERNATIVA 3.
- **Objetivo (según instructivo):** Información no determinada por los archivos proporcionados.
- **Hoja Excel:** `Evaluación Social Alt3`
- **JSON `id` de sección:** `14`
...
**Esta guía documenta la Alternativa 3** (JSON id `14`).

### Subsecciones / grupos

- `14.01` — 10.01 BENEFICIOS SOCIALES
- `14.02` — 10.02 COSTOS SOCIALES
- `14.03` — 10.03 FLUJO DE COSTOS A PRECIOS SOCIALES (EVALUACIÓN SOCIAL)
- `14.04` — 10.04 INDICADORES DE RENTABILIDAD SOCIAL
- `14.05` — 10.05 ANÁLISIS DE SENSIBILIDAD
...
## Campo 14.01.1 — Benificios de la intervención
...
## Campo 14.02.1 — Transformación de costos de inversión a precios sociales
...
**Config:** `{"filas": "planas", "columnas": "fijas", "agrupador": false, "abarca_filas": 1, "agrupador_abarca_columnas": 1}`
...
## Campo 14.02.2 — Transformación de costos de operación y mantenimiento a precios sociales
...
## Campo 14.03.1 — FLUJO DE COSTOS A PRECIOS SOCIALES (EVALUACIÓN SOCIAL)
...
## Campo 14.04.1 — INDICADORES DE RENTABILIDAD SOCIAL
...
## Campo 14.05.1 — ANALISIS DE SENSIBILIDAD BIDIMENSIONAL
...
| id | Nombre | Tipo |
|---|---|---|
| `eje_beneficiarios` | ICE / VAN | texto_corto |
...
|---|---|---|---|---|
| 14.01.1 | Benificios de la intervención | tabla | Sí | Llenar tabla |
| 14.02.1 | Transformación de costos de inversión a precios sociales | tabla | Sí | Llenar tabla |
| 14.02.2 | Transformación de costos de operación y mantenimiento a precios sociales | tabla | Sí | Llenar tabla |
| 14.03.1 | FLUJO DE COSTOS A PRECIOS SOCIALES (EVALUACIÓN SOCIAL) | tabla | Sí | Llenar tabla |
| 14.04.1 | INDICADORES DE RENTABILIDAD SOCIAL | tabla | Sí | Llenar tabla |
| 14.05.1 | ANALISIS DE SENSIBILIDAD BIDIMENSIONAL | tabla | Sí | Llenar tabla |
