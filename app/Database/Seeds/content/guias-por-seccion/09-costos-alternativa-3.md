# SECCIÓN N°09: COSTOS DEL PROYECTO - ALTERNATIVA 3

## Descripción de la sección

- **Qué representa:** SECCIÓN N°09: COSTOS DEL PROYECTO - ALTERNATIVA 3.
- **Objetivo (según instructivo):** Información no determinada por los archivos proporcionados.
- **Hoja Excel:** `CostosAlt3`
- **JSON `id` de sección:** `11`
...
**Esta guía documenta la Alternativa 3** (JSON id `11`).

### Subsecciones / grupos

- `11.01` — 9.01 Costo de ejecución física de las acciones
- `11.02` — 9.02 Costos de reinversión
- `11.03` — 9.03 Costos de operación y mantenimiento con y sin proyecto
- `11.04` — 9.04 Cronograma de inversión de metas financieras
- `11.05` — 9.05 Cronograma de metas físicas
...
## Campo 11.01.5 — Medidas de reducción del riesgo de desastre y mitigación ambiental
...
## Campo 11.01.6 — Sub Total de costos directos
...
## Campo 11.01.7 — Costos indirectos
...
## Campo 11.01.8 — Subtotal de otros costos de inversión
...
## Campo 11.01.9 — Costo Total de inversión
...
## Campo 11.02.1 — Costos de reinversión
...
## Campo 11.03.1 — Fecha prevista de inicio de operaciones (mes / año)
...
## Campo 11.03.2 — Horizonte de funcionamiento (años)
...
## Campo 11.03.3 — Costos de operación y mantenimiento — Situación sin proyecto
...
## Campo 11.03.4 — Total de costos de operación y mantenimiento (sin proyecto)
...
## Campo 11.03.5 — Costos de operación y mantenimiento — Situación con proyecto
...
## Campo 11.03.6 — Total de costos de operación y mantenimiento (con proyecto)
...
## Campo 11.04.1 — Fecha prevista de inicio de ejecución (mes y año)
...
## Campo 11.04.3 — Número de periodos
...
## Campo 11.04.4 — Cronograma de inversión de metas financieras
...
## Campo 11.04.5 — Sub total del cronograma de inversión
...
## Campo 11.04.7 — Sub total de otros costos
...
## Campo 11.04.8 — Costo total de inversión
...
## Campo 11.04.9 — Control concurrente
...
## Campo 11.05.1 — Cronograma de metas físicas
...
|---|---|---|---|---|
| 11.01.1 | Componente 1 | tabla | Sí | Llenar tabla |
| 11.01.2 | Componente 2 | tabla | Sí | Llenar tabla |
| 11.01.3 | Componente 3 | tabla | Sí | Llenar tabla |
| 11.01.4 | Componente 4 | tabla | Sí | Llenar tabla |
| 11.01.5 | Medidas de reducción del riesgo de desastre y mitigación ambiental | tabla | Sí | Llenar tabla |
| 11.01.6 | Sub Total de costos directos | calculado | No | NO LLENAR |
| 11.01.7 | Costos indirectos | tabla | Sí | Llenar tabla |
| 11.01.8 | Subtotal de otros costos de inversión | calculado | No | NO LLENAR |
| 11.01.9 | Costo Total de inversión | calculado | No | NO LLENAR |
| 11.02.1 | Costos de reinversión | tabla | Sí | Llenar tabla |
| 11.03.1 | Fecha prevista de inicio de operaciones (mes / año) | calculado | No | NO LLENAR |
| 11.03.2 | Horizonte de funcionamiento (años) | decimal | Sí | Llenar |
| 11.03.3 | Costos de operación y mantenimiento — Situación sin proyecto | tabla | Sí | Llenar tabla |
| 11.03.4 | Total de costos de operación y mantenimiento (sin proyecto) | calculado | No | NO LLENAR |
| 11.03.5 | Costos de operación y mantenimiento — Situación con proyecto | tabla | Sí | Llenar tabla |
| 11.03.6 | Total de costos de operación y mantenimiento (con proyecto) | calculado | No | NO LLENAR |
| 11.04.1 | Fecha prevista de inicio de ejecución (mes y año) | calculado | No | NO LLENAR |
| 11.04.2 | Tipo de periodo | texto_corto | Sí | Llenar |
| 11.04.3 | Número de periodos | decimal | Sí | Llenar |
| 11.04.4 | Cronograma de inversión de metas financieras | tabla | Sí | Llenar tabla |
| 11.04.5 | Sub total del cronograma de inversión | calculado | No | NO LLENAR |
| 11.04.6 | Otros costos | tabla | Sí | Llenar tabla |
| 11.04.7 | Sub total de otros costos | calculado | No | NO LLENAR |
| 11.04.8 | Costo total de inversión | calculado | No | NO LLENAR |
| 11.04.9 | Control concurrente | decimal | Sí | Llenar |
| 11.05.1 | Cronograma de metas físicas | tabla | Sí | Llenar tabla |
