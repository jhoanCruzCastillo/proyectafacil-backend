...
$routes->group('api', ['filter' => 'auth'], static function (RouteCollection $routes) {
    ...
    $routes->post('asesoria/tickets/(:num)/completar-video', 'TicketsAsesoriaController::completarVideo/$1');
    ...
    $routes->get('asesoria/configuracion-videollamadas', 'TicketsAsesoriaController::configuracionVideoconferencia');
    $routes->put('asesoria/configuracion-videollamadas', 'TicketsAsesoriaController::actualizarConfiguracionVideoconferencia');
